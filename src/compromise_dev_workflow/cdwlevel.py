...
player_dir = os.path.join(this_directory, "player")
...
class CDWLevel:
    ...
    def build_necessary_images(self):
        ...
        self.player_image = self.client.images.build(path=player_dir, tag=self.PLAYER_IMAGE_NAME, rm=True)
    ...
    def teardown_level(self, remove_images=False):
        ...
        if remove_images:
            ...
            self._ensure_image_is_removed(self.PLAYER_IMAGE_NAME)
